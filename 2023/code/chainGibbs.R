...
chainGibbsUserStart = function(mcmc.size,alpha,beta,start.n111){
  # Last updated, June 17, 2010/KA
  #
  ...
  # sampling (see the lecture notes).
  #
  # INPUT M          = the number of MCMC iterations
  #       alpha,beta = parameters of the Beta prior distribution
  #                    of the escape probability
  #
  # OUTPUT chainGibbs = the MCMC sample of q and n111 as a list
  #                     of two entries, each a vector of length M
  ...
  # Initialize the model unknowns
  q[1]    = 0.5;                         # just an initial guess
  n111[1] = start.n111 # the (rounded) expected value of n_111, 
  # given q =0.5 
