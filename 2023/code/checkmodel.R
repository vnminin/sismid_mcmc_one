...
# distribution of the escape probability q and a subsequent draw from the 
# corresponding multinomial distribution. In this model, the escape probability 
# is the same across all 334 households.
#
# The function outputs the mean of the predictive distribution, based on the 
# sample. In addition, the joint predictive distribution of 
# frequencies n1 and n11 is plotted. 
#
...
# The posterior predictive expected frequencies of the four chain types
...
mcmc.sample1 = chainGibbs(5000,1,1)

## or
# mcmc.sample = mychainGibbs(34,25,275,5000,1,1)

# Check the model fit
checkmodel(mcmc.sample1,mcmc.burnin=500)
