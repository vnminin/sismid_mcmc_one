#########################################################################
# This script contains routines to draw samples from the joint posterior 
...
# the final number infected as 3. In its current form, only the samples of alpha and beta 
# are returned as output from this function.
#
